    ...
    <div class="main-container">
        <main class="main wrapper">
            ...
            <div class="product-section">
                <div class="container">
                    <div class="row">
                        @foreach($category->FinalCategories as $cid =>$cat)
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="section-content " data-aos="fade-up">
                                                    ...
                                                    @if($product->pdf !='[]')
                                                        ...
                                                        @php $file = json_decode($product->pdf)->download_link; @endphp
                                                        {{voyager::image($file)}}
                                                        <a href="{{voyager::image($product->pdf)}}" class="downlode-link" download>
